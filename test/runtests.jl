...
@testset "UnbalancedOptimalTransport.jl" begin
    ...
    @testset "regularized OT! with balancing via $D" for D in TEST_DIVERGENCES
        for ϵ ∈ (0.1, 1.0)
            ...
            # I think the optimal coupling should be unique in the case of the KL divergence,
            # but I can't get any tests like the following to consistently pass.
            # I think there's something wrong with `optimal_coupling`, so I'll comment it out for now.
